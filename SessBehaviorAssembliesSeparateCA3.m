function SessBehaviorAssembliesSeparateCA3(varargin)
...
if exist(strcat('Summ\AssembliesSeparate.mat'),'file') && ~force 
    ...
    if saveMat
        save([expPath '\Summ\' 'AssembliesSeparate.mat'], 'Assemblies','-v7.3');
    end
end
