function [behavTrials] = getCueBehavior(varargin)
...
if updatedIntan % base solenoid should have this information
    ...
    solChoice = digitalIn.ints{9}(1,:);
else
    %see which solenoid trials coincide with base
    solTS = digitalIn.ints{9}(1,:);
    solBase = InIntervals(solTS,[digitalIn.intsPeriods{10}(:,1)-0.5 digitalIn.intsPeriods{10}(:,1)]); % base pulses must be within 0.5 seconds of base IR
    %end of trial coincides with baseIR
