function [phaseamplitude] = bz_PhaseAmplitudeDistIZ(lfp,phaserange,amprange,varargin)
...
if ~useCSD
    ...
    filtered_phase = bz_Filter(lfpPyrCh,'passband',phaserange,'filter',filterType,'order',filterOrder,'intervals',intervals);
end
...
wavespec_amp.data = abs(wavespec_amp.data); %log scaled for normality
