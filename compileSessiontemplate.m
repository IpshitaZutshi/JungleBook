...
mice = {'IZ11\Final','IZ12\Final\','IZ13\Final','IZ15\Final','IZ17\Final','IZ18\Final','IZ20\Final','IZ21\Final','IZ23\Final',...
     ...
     'IZ32\Final','IZ32\Saline', 'IZ33\Final','IZ33\Saline','IZ34\Final','IZ34\Saline'};
...
for m = 1:length(mice)
    ...
    for ii = 1:size(allSess,1)
        ...
        elseif strcmp(mice{m},'IZ34\Final') == 1 || strcmp(mice{m},'IZ34\Saline') == 1       
            ...
            session.brainRegions.CA1.channels = 1:(sessionInfo.nChannels-5); 
            session.brainRegions.CA3.channels = [];
            session.brainRegions.DG.channels = [];
        end
        ...
        %Save session file
        save([allSess(ii).name '.session.mat'],'session');
