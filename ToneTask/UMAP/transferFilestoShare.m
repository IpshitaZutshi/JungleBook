...
umap_path = 'Z:\Buzsakilabspace\Datasets\ZutshiI\Nature2024\';%'Z:\Buzsakilabspace\LabShare\WinnieYang\Ipshita\NatureRevisions';

for ss = 1:length(sess)
    cd(strcat(expPath,sess{ss}))

    destPath = strcat(umap_path,'\',sess{ss}(1:5),sess{ss}(12:end));
    ...
    files_to_copy = {'*.spikes.cellinfo.mat', '*.Tracking.Behavior.mat', '*TrialBehavior.Behavior.mat', ...
                     ...
                     % ,'*rateMapsAvg.cellinfo.mat','*rateMapsAvg2D.cellinfo.mat',...
