function Deceleration = findDecelerationPoints(varargin)
...
if plotfig
    ...
    plotAvgStd(Deceleration.velPSTH,2,2,1,fig2,tAxis',[0 0 1])
    title('Speed')
    
    plotAvgStd(Deceleration.accPSTH,2,2,3,fig2,tAxis',[0 0 1])
    title('Acceleration')
    
    subplot(2,2,2)
    scatter(Deceleration.timetoLick1(Deceleration.decType==1), Deceleration.posY(Deceleration.decType==1), 5,'b')
    hold on
    scatter(Deceleration.timetoLick1(Deceleration.decType==2), Deceleration.posY(Deceleration.decType==2), 5,'k')
    scatter(Deceleration.timetoLick1(Deceleration.decType>=3), Deceleration.posY(Deceleration.decType>=3), 5,'m')
    xlabel('time')
    ylabel('Position')
