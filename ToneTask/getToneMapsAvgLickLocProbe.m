function getToneMapsAvgLickLocProbe(varargin)
...
%No (var) strials
idx{1} = behavTrials.lickLoc ==0 & behavTrials.linTrial ==0 & behavTrials.probe == 0;
idx{2} = behavTrials.lickLoc ==1 & behavTrials.linTrial ==0 & behavTrials.probe == 0;
idx{3} = behavTrials.lickLoc ==2 & behavTrials.linTrial ==0 & behavTrials.probe == 0;
idx{4} = behavTrials.lickLoc ==3 & behavTrials.linTrial ==0 & behavTrials.probe == 0;
idx{5} = behavTrials.lickLoc ==4 & behavTrials.linTrial ==0 & behavTrials.probe == 0;
idx{6} = behavTrials.lickLoc ==5 & behavTrials.linTrial ==0 & behavTrials.probe == 0;

% (var) trials
idx{7} = behavTrials.lickLoc ==0 & behavTrials.linTrial ==0 & behavTrials.probe ==1;
idx{8} = behavTrials.lickLoc ==1 & behavTrials.linTrial ==0 & behavTrials.probe ==1;
idx{9} = behavTrials.lickLoc ==2 & behavTrials.linTrial ==0 & behavTrials.probe ==1;
idx{10} = behavTrials.lickLoc ==3 & behavTrials.linTrial ==0 & behavTrials.probe ==1;
idx{11} = behavTrials.lickLoc ==4 & behavTrials.linTrial ==0 & behavTrials.probe ==1;
...
save([sessionInfo.FileName '.rateMapsAvgLickLocProbe.cellinfo.mat'],'firingMaps'); 
