function sessionRemappingTrajectory
...
sess = {'IZ39\Final\IZ39_220622_sess8','IZ39\Final\IZ39_220629_sess12',...
    ...
    'IZ44\Final\IZ44_220828_sess5','IZ44\Final\IZ44_220913_sess11'... 
    'IZ44\Final\IZ44_220912_sess10','IZ44\Final\IZ44_220919_sess14',...
...
for ii = 1:length(sess)
    ...
    % Skip sessions that have less than 5 post-tone trial linear trials
    if sum(trialLabel==3)<5
        continue;
    end
    ...
    for kk=1:length(cell_metrics.UID)
        ...
        %% Now extract firing map of each catergory according to trajectories
...
for ii = 1:17
    data{ii} = AllCellsCorr(:,ii);
end

stats = groupStats(data);
xticklabels({'1-3','2-3','1a-1b','1a-2a','1a-2b','1a-3a','1a-3b','1b-2a','1b-2b','1b-3a','1b-3b','2a-2b','2a-3a','2a-3b','2b-3a','2b-3b','3a-3b'})
end
