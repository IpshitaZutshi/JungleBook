function plotErrorTrials_Figure4
...
saveas(gcf,strcat(expPath,'\Compiled\Figures_Sep23\Figure4_errorTrials.png'));
saveas(gcf,strcat(expPath,'\Compiled\Figures_Sep23\Figure4_errorTrials.eps'),'epsc');
saveas(gcf,strcat(expPath,'\Compiled\Figures_Sep23\Figure4_errorTrials.fig'));
save(strcat(expPath,'\Compiled\Figures_Sep23\Figure4_errorTrials.mat'),'Fig4Stats'); 
