...
subplot(numrows,numcol,4,'Parent', fig2)
...
col = [140/255 81/255 10/255;...
    216/255 179/255 101/255;...
    246/255 232/255 195/255;...
    199/255 234/255 229/255;...
    90/255 180/255 172/255;...
    1/255 102/255 94/255];
...
saveas(gcf,strcat(expPath,'\Compiled\Figures_Sep23\Figure1_behaviorSummary.png'));
saveas(gcf,strcat(expPath,'\Compiled\Figures_Sep23\Figure1_behaviorSummary.eps'),'epsc');
saveas(gcf,strcat(expPath,'\Compiled\Figures_Sep23\Figure1_behaviorSummary.fig'));
save(strcat(expPath,'\Compiled\Figures_Sep23\Figure1_behaviorStats.mat'),'Fig1Stats'); 
end