...
A_all = [0.82,98.6742,-182.76,191,23];
...
for ii = 1:length(umap_path)
    ...
    %     'numrow',length(umap_path),'numcol',4,'rowloc',ii,'colloc',1,'col',col,'TRIAL_TYPE', TRIAL_TYPE,'A',A,'E',E)
    manifoldPlot('figHandle',fig2,'umap_path',umap_path{ii},'umap_name',umap_name,'behav_file',behav_file,...
         'numrow',2,'numcol',2,'rowloc',1,'colloc',1,'col',col,'TRIAL_TYPE', TRIAL_TYPE,'A',A,'E',E)

    % ax1 = subplot(1,4,1,'Parent',fig2);
    % ax2 = subplot(1,4,2,'Parent',fig2);
    ...
    manifoldPlot('figHandle',fig2,'umap_path',umap_path{ii},'umap_name',umap_name,'behav_file',behav_file,...
    'numrow',2,'numcol',2,'rowloc',2,'colloc',1,'col',col,'TRIAL_TYPE', TRIAL_TYPE,'A',A,'E',E)
