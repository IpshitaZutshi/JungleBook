function plotTrajectorySpatial_Figure3
...
sessloc = 'Z:\Homes\zutshi01\Recordings\Auditory_Task\IZ39\Final\IZ39_220707_sess17';
cd(sessloc)
cellNum = 44;
file = dir(['*.spikeData.cellinfo.mat']);
load(file.name);
...
maxFR = max([nanmean(Maps{1}) nanmean(Maps{2})]);
...
Fig3Stats = groupStats([{Summary.comp1},{Summary.comp2},{Summary.comp3},{Summary.comp4}],[],'color',col,'inAxis',true','plotType','boxplot','labelSummary',false);
xticks('auto')
xticklabels({'','SC,ST','SC,DT','DC,ST','DC,DT'})

expPath = 'Z:\Homes\zutshi01\Recordings\Auditory_Task';
saveas(gcf,strcat(expPath,'\Compiled\Figures\Figure3_trajectTuning.png'));
saveas(gcf,strcat(expPath,'\Compiled\Figures\Figure3_trajectTuning.eps'),'epsc');
saveas(gcf,strcat(expPath,'\Compiled\Figures\Figure3_trajectTuning.fig'));
save(strcat(expPath,'\Compiled\Figures\Figure3_trajectTuning.mat'),'Fig3Stats'); 
