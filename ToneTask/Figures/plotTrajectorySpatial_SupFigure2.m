function plotTrajectorySpatial_SupFigure2
...
SupFig2Stats.Maps2D = groupStats({Summary.linCorr,Summary.toneNoToneCorr,Summary.tonelinEndCorr},[],...
    'inAxis',true,'plotType','boxplot','color',col,'labelSummary',false);

expPath = 'Z:\Homes\zutshi01\Recordings\Auditory_Task';
saveas(gcf,strcat(expPath,'\Compiled\Figures\SupFigure2_trajectTuning.png'));
saveas(gcf,strcat(expPath,'\Compiled\Figures\SupFigure2_trajectTuning.eps'),'epsc');
saveas(gcf,strcat(expPath,'\Compiled\Figures\SupFigure2_trajectTuning.fig'));
save(strcat(expPath,'\Compiled\Figures\SupFigure2_trajectTuning.mat'),'SupFig2Stats'); 
