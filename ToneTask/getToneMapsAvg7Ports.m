...
if isempty(jumpLin)
    ...
    idx{30} = linIdx(1:round(length(linIdx)/2)); % Idx of first half of initial runs
    idx{31} = linIdx(round(length(linIdx)/2)+1:end); % Idx of second half of initial runs
    idx{32} = []; % Idx of later runs         
else
    idx{1} = linIdx(1:jumpLin); % Idx of initial runs
    idx{30} = linIdx(1:round(jumpLin/2)); % Idx of first half of initial runs
    idx{31} = linIdx(round(jumpLin/2)+1:jumpLin); % Idx of second half of initial runs
    idx{32} = linIdx(jumpLin+1:end); % Idx of later runs      
end
%No stim strials
idx{2} = behavTrials.toneGain ==0 & behavTrials.correct==1 & behavTrials.linTrial ==0 & behavTrials.stim ==0;
idx{3} = behavTrials.toneGain ==1 & behavTrials.correct==1 & behavTrials.linTrial ==0 & behavTrials.stim ==0;
idx{4} = behavTrials.toneGain ==2 & behavTrials.correct==1 & behavTrials.linTrial ==0 & behavTrials.stim ==0;
idx{5} = behavTrials.toneGain ==3 & behavTrials.correct==1 & behavTrials.linTrial ==0 & behavTrials.stim ==0;
idx{6} = behavTrials.toneGain ==4 & behavTrials.correct==1 & behavTrials.linTrial ==0 & behavTrials.stim ==0;
idx{7} = behavTrials.toneGain ==5 & behavTrials.correct==1 & behavTrials.linTrial ==0 & behavTrials.stim ==0;
idx{8} = behavTrials.toneGain ==0 & behavTrials.correct==0 & behavTrials.linTrial ==0 & behavTrials.stim ==0;
idx{9} = behavTrials.toneGain ==1 & behavTrials.correct==0 & behavTrials.linTrial ==0 & behavTrials.stim ==0;
idx{10} = behavTrials.toneGain ==2 & behavTrials.correct==0 & behavTrials.linTrial ==0 & behavTrials.stim ==0;
idx{11} = behavTrials.toneGain ==3 & behavTrials.correct==0 & behavTrials.linTrial ==0 & behavTrials.stim ==0;
idx{12} = behavTrials.toneGain ==4 & behavTrials.correct==0 & behavTrials.linTrial ==0 & behavTrials.stim ==0;
idx{13} = behavTrials.toneGain ==5 & behavTrials.correct==0 & behavTrials.linTrial ==0 & behavTrials.stim ==0;    

% Stim trials
idx{14} = behavTrials.toneGain ==0 & behavTrials.correct==1 & behavTrials.linTrial ==0 & behavTrials.stim ==1;
idx{15} = behavTrials.toneGain ==1 & behavTrials.correct==1 & behavTrials.linTrial ==0 & behavTrials.stim ==1;
idx{16} = behavTrials.toneGain ==2 & behavTrials.correct==1 & behavTrials.linTrial ==0 & behavTrials.stim ==1;
idx{17} = behavTrials.toneGain ==3 & behavTrials.correct==1 & behavTrials.linTrial ==0 & behavTrials.stim ==1;
idx{18} = behavTrials.toneGain ==4 & behavTrials.correct==1 & behavTrials.linTrial ==0 & behavTrials.stim ==1;
idx{19} = behavTrials.toneGain ==5 & behavTrials.correct==1 & behavTrials.linTrial ==0 & behavTrials.stim ==1;
idx{20} = behavTrials.toneGain ==0 & behavTrials.correct==0 & behavTrials.linTrial ==0 & behavTrials.stim ==1;
idx{21} = behavTrials.toneGain ==1 & behavTrials.correct==0 & behavTrials.linTrial ==0 & behavTrials.stim ==1;
idx{22} = behavTrials.toneGain ==2 & behavTrials.correct==0 & behavTrials.linTrial ==0 & behavTrials.stim ==1;
idx{23} = behavTrials.toneGain ==3 & behavTrials.correct==0 & behavTrials.linTrial ==0 & behavTrials.stim ==1;
idx{24} = behavTrials.toneGain ==4 & behavTrials.correct==0 & behavTrials.linTrial ==0 & behavTrials.stim ==1;
idx{25} = behavTrials.toneGain ==5 & behavTrials.correct==0 & behavTrials.linTrial ==0 & behavTrials.stim ==1;  

%correct vs incorrect
idx{26} = behavTrials.correct==0 & behavTrials.linTrial ==0 & behavTrials.stim ==0;
idx{27} = behavTrials.correct==1 & behavTrials.linTrial ==0 & behavTrials.stim ==0;  
idx{28} = behavTrials.correct==0 & behavTrials.linTrial ==0 & behavTrials.stim ==1;
idx{29} = behavTrials.correct==1 & behavTrials.linTrial ==0 & behavTrials.stim ==1;  
