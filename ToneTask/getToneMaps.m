...
if plotfig
    ...
    idx{8} = firingMaps.toneGain ==0 & firingMaps.toneTrial ==0 & firingMaps.correct==0 & firingMaps.linTrial ==0;
    idx{9} = firingMaps.toneGain ==1 & firingMaps.toneTrial ==0 & firingMaps.correct==0 & firingMaps.linTrial ==0;
    idx{10} = firingMaps.toneGain ==2 & firingMaps.toneTrial ==0 & firingMaps.correct==0 & firingMaps.linTrial ==0;
    ...
    for pf = 1:length(firingMaps.forward.rateMaps)
         ...
         for ll = 1:length(labels)
             for ii = 1:length(idx)
                ...
                subplot(3,10,10*(ll-1)+ii) % linear trials
