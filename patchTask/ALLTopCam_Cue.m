...
addParameter(p,'useNose',false,@islogical);
...
for s = 1:length(sessions)
    ...
    if saveMat
        if useNose
            save([basepath filesep fbasename '.Tracking.Nose.mat'],'tracking');
        else            
