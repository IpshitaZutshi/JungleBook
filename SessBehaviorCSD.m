function SessBehaviorCSD(varargin)
...
if exist('Summ\csdData.mat','file') && ~force 
    disp('Theta CSD already computed! Loading file.');
    load('Summ\csdData.mat');
else
    for rr = 1:3
        for cc = 1:2
            for zz = 1:6
    ...
    for ii = 1:size(allSess,1)
        ...
        for jj = 1:length(efields)
            ...
            for zz = 1:6
                ...
                [csd.orCh{zz}, lfpAvg.orCh{zz}] = bz_eventThetaCSD2(lfp,events,'twin',[twin twin],'plotLFP',false,'plotCSD',false,'thetaCh',orCh);
                [csd.slmCh{zz}, lfpAvg.slmCh{zz}] = bz_eventThetaCSD2(lfp,events,'twin',[twin twin],'plotLFP',false,'plotCSD',false,'thetaCh',slmCh,'invert',true);
