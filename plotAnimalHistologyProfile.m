function plotAnimalHistologyProfile

animalID = {'IZ20','IZ21','IZ28','IZ33'};%'IZ18','IZ20','IZ21','IZ23','IZ24','IZ25','IZ26',...
    %'IZ27','IZ28','IZ29','IZ30','IZ31','IZ32','IZ33','IZ11'};%'IZ19','IZ17','IZ12','IZ13','IZ15',
histologyLoc = 'C:\Users\ipshi\Desktop\TrackData\Images\';%append_new
...
%     tcl.Padding = 'compact';
    ...
    ax = gca;
    figure(1)
    s1 = subplot(1,8,[1 2],'parent',fig1);
    ...
    plot(csdRippleProfile,nC,'color',[.4 .4 .4]);
    hold on
    plot(xs, [find(channel_order==hippocampalLayers.pyramidal) find(channel_order==hippocampalLayers.pyramidal)],'color',[.8 .2 1],'LineWidth',1.5);
    text(xs(2), find(channel_order==hippocampalLayers.pyramidal),'Pyr','color',[.8 .2 1]);
    ...
    plot(csdThetaProfile,nC,'color',[.4 .4 .4]);
    hold on
    plot(xs, [find(channel_order==hippocampalLayers.pyramidal) find(channel_order==hippocampalLayers.pyramidal)],'color',[.8 .2 1],'LineWidth',1.5);
    text(xs(2), find(channel_order==hippocampalLayers.pyramidal),'Pyr','color',[.8 .2 1]);
