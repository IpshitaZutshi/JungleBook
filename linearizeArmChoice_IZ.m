...
function [behavior] = linearizeArmChoice_IZ(varargin)
...
cd(basepath); cd ..; cd ..; upBasepath = pwd; cd(basepath);
...
trials0 = [armChoice.timestamps [armChoice.timestamps(2:end); t(end)]]; % trials defined as epochs at reward IR crossing\
