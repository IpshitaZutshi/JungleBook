function M = plotLFPtraceRippleStimSpikes%(lfp,events)

cd('Z:\Homes\zutshi01\Recordings\CA1_silencing\IZ21\Final\IZ21_0um_200814_sess4')
...
totalTime = 50;
eventNum = 35;%68;
startPoint = (78*60*1250)+(50*1250);%round((behavior.events.startPoint(eventNum)-preTime)*1250);

% Actual TS of startPoint
TS = lfp.timestamps(startPoint:startPoint+(totalTime*1250));
stimTS = startPoint:startPoint+(totalTime*1250);
data = double(lfp.data(startPoint:startPoint+(totalTime*1250),:))-arr;
...
V = VideoWriter('C:\Users\ipshi\Desktop\CSDtraceRippleSpikes2','MPEG-4');
V.FrameRate = 5;
V.Quality = 100;
open(V)
writeVideo(V,M)
